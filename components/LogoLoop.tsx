  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const nodeItem = isNodeItem
          ? (item as Extract<LogoItem, { node: React.ReactNode }>)
          : null;
        const imgItem = !isNodeItem
          ? (item as Extract<LogoItem, { src: string }>)
          : null;
