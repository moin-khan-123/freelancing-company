...
//         const nodeItem = isNodeItem ? (item as Extract<LogoItem, { node: React.ReactNode }>) : null;
//         const imgItem = !isNodeItem ? (item as Extract<LogoItem, { src: string }>) : null;
...
//         const inner = (nodeItem?.href ?? imgItem?.href) ? (
//           <a
//             className={cx(
...
//             )}
//             href={nodeItem?.href ?? imgItem?.href ?? ''}
